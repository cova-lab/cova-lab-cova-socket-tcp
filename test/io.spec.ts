...
import { BinaryEncoding } from "@cova/core/common";
import { IOTestStand, TestUtil } from "@cova/test/util/test.util";
...
describe("SocketIO", () => {
  ...
  it("List messages", async () => {
    ...
    expect(listMsgRes.body[1].message).toEqual({
      format: "string",
      event: "type:any",
      data: "string msg",
    });
    ...
    expect(listMsgRes.body[2].message).toEqual({
      format: "string",
      event: "type:any",
      data: "string msg",
    });
